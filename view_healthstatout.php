...
<body>
  ...
  <ul id="slide-out" class="side-nav fixed main-side">
    ...
    <div class="content">
      <div id="content-wrap">
      <h3 class="center-align">View Health Status of Out-Patients</h3><br><br>
  ...
  <div id="admin" class="col s12">
    <div class="card material-table">
      <!-- <div class="table-header">
        <span class="table-title red-text"><b>Total In-patients</b></span>
      </div> -->
<?php
extract($_POST);
if(isset($save)) 
...
if ($qsql->num_rows > 0) {
echo "<table id='datatable'><thead><tr><th><b>Patient Id</b></th><th><b>Patient Name</b></th><th><b>Gender</b></th><th><b>Age</b></th><th><b>Date</b></th><th><b>Body temp</b></th><th><b>O2 Level</b></th><th><b>Pulse rate</b></th><th><b>Body pain</b></th><th><b>Cough/cold</b></th><th><b>Smell/taste</b></th><th><b>Breath</b></th><th><b>Comorbities</b></th><th><b>Doubts</b></th><th><b>Reply</b></th></tr></thead>";
// // output data of each row
while($row = $qsql->fetch_assoc()) {
$sql1="select * from health_status_out where (date between '$from' and '$to') and pat_id='".$row['pat_id']."' ";
$qsql1 = mysqli_query($con,$sql1);
$sql2="select name,gender,age from patient_reg where pat_id='".$row['pat_id']."'";
$qsql2 = mysqli_query($con,$sql2); 
$row2 = $qsql2->fetch_assoc();
if ($qsql1->num_rows > 0) {
while($row1 = $qsql1->fetch_assoc()){
if($row1['doc_comments']==NULL)
{
echo "<tbody><tr><td>" . $row1['pat_id']. "</td><td>" . $row2['name']. "</td><td>" . $row2['gender']. "</td><td>" . $row2['age']. "</td><td>"  . $row1['date']. "</td><td>"  . $row1['body_temp']. "</td><td>". $row1['o2']. "</td><td> " . $row1['pulse_rate'].  "</td><td> " . $row1['body_pain'].  "</td><td> " . $row1['cough_cold'].  "</td><td> " . $row1['smell_taste'].  "</td><td> " . $row1['breath'].  "</td><td> " . $row1['comorbities'].  "</td><td> " . $row1['doubts'].  "</td><td> <a name='reply'  href='reply_out.php?h_id=".$row1['h_id']."' class='red waves-effect waves-light btn-large'>REPLY</a></td></tr></tbody>";
}
else{
echo "<tbody><tr><td>" . $row1['pat_id']. "</td><td>" . $row2['name']. "</td><td>" . $row2['gender']. "</td><td>" . $row2['age']. "</td><td>"  . $row1['date']. "</td><td>"  . $row1['body_temp']. "</td><td>". $row1['o2']. "</td><td> " . $row1['pulse_rate'].  "</td><td> " . $row1['body_pain'].  "</td><td> " . $row1['cough_cold'].  "</td><td> " . $row1['smell_taste'].  "</td><td> " . $row1['breath'].  "</td><td> " . $row1['comorbities'].  "</td><td> " . $row1['doubts'].  "</td><td> <a class='green waves-effect waves-light btn-large'>REPLIED</a></td></tr></tbody>";
}
}
