...
<body>
  ...
  <ul id="slide-out" class="side-nav fixed main-side">
    ...
    <div class="content">
      <div id="content-wrap">
      <h3 class="center-align">View Health Status of In-Patients</h3><br><br>
      ...
      <?php
        ...
        if(isset($save)) 
        {
            ...
            if ($qsql->num_rows > 0) {
                ...
                echo "<table id='datatable'><thead><tr><th><b>Patient Id</b></th><th><b>Patient Name</b></th><th><b>Gender</b></th><th><b>Age</b></th><th><b>Date</b></th><th><b>Medications</b></th><th><b>Comorbodities</b></th><th><b>Doubts</b></th><th><b>Reply</b></th></tr></thead>";
                // // output data of each row
                while($row = $qsql->fetch_assoc()) {
            $sql1="select * from health_status_in where (date between '$from' and '$to') and pat_id='".$row['pat_id']."' ";
            ...
            if ($qsql1->num_rows > 0) {
                while($row1 = $qsql1->fetch_assoc()){
                  ...
                  {
                  echo "<tbody><tr><td>" . $row1['pat_id']. "</td><td>" . $row2['name']. "</td><td>" . $row2['gender']. "</td><td>" . $row2['age']. "</td><td>"  . $row1['date']. "</td><td>"  . $row1['medi']. "</td><td>". $row1['comor']. "</td><td> " . $row1['doubts'].  "</td><td> <a name='reply'  href='reply_in.php?h_id=".$row1['h_id']."' class='red waves-effect waves-light btn-large'>REPLY</a></td></tr></tbody>";
                  }
                  else{
                   echo "<tbody><tr><td>" . $row1['pat_id']. "</td><td>" . $row2['name']. "</td><td>" . $row2['gender']. "</td><td>" . $row2['age']. "</td><td>"  . $row1['date']. "</td><td>"  . $row1['medi']. "</td><td>". $row1['comor']. "</td><td> " . $row1['doubts'].  "</td></td><td> <a class='green waves-effect waves-light btn-large'>REPLIED</a></td></tr></tbody>";
                  }
                 }
