...
{
$sql = " SELECT * FROM doc_reg WHERE place = '" . $_POST["place"]."' AND Specialisation= '" . $_POST["specialisation"]."' ";
...
?>
  <td><a name="book" class="red waves-effect waves-light btn-large" href="booking.php?doc_id=<?php echo $row['doc_id']?>">BOOK</a></td>;
...
echo "<div class='row'>";
echo "<div class='input-field submitbutton'>";
echo "<center>";
echo "<button class='btn waves-effect waves-light black' type='submit' name='submit' value='submit'>Search again<i class='material-icons right'>send</i></button>";
echo "</center>";
echo "</div>";
echo "</div>";
}
