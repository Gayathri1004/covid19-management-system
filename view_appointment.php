...
$sql = " SELECT * FROM doc_details WHERE pat_id = '".$_SESSION["pat_id"]."'  ";
...
?>
<td>
<a name="cancel"  href="cancel_appointment.php?book_id=<?php echo $row['book_id']?>" class="red waves-effect waves-light btn-large">CANCEL</a></td>
