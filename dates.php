...
<body>
  ...
  <ul id="slide-out" class="side-nav fixed main-side">
    ...
    <li class="lone">
        <a class="waves-effect" href="dates.php"><i class="fa fa-calendar my-icon"></i>Enter date in/out</a></li>
   
    <li class="dropchange">
      <ul class="collapsible" data-collapsible="accordion">
        <li>
          <div class="collapsible-header head">
            <p style="margin:0px;padding-left:16px;"><i class="fa fa-thermometer-full my-icon"></i><b>Health status</b><i class="fa fa-angle-right changed"></i></p>
          </div>
          <div class="collapsible-body">
            <ul>
              <li><a class="waves-effect" href="health_status_in.php">Enter status</a></li>
              <li><a class="waves-effect" href="#">View Doctor comments</a></li>
            </ul>
          </div>
        </li>
      </ul>
  ...
  <div id="page-container">
    <div class="content">
      <div id="content-wrap">
      <form method="post" action="date_test.php" class="center-align" >
  ...
  <div class="row">
    <div class="row">
        <div class="col s12">
        <h5 class="red-text"> Enter date of admission: </h5>
          <div class="input-field inline">
          <input  type="date" name="date_in" class="validate">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col s12">
        <h5 class="red-text"> Enter date of discharge: </h5>
          <div class="input-field inline">
          <input  type="date" name="date_out" class="validate">
          </div>
        </div>
      </div>
