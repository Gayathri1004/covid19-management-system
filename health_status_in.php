...
<body>
  ...
  <div id="page-container">
    <div class="content">
      <div id="content-wrap">
      <form method="post" action="status_entry_in.php" class="center-align" >
  ...
  <div class="row">
    <div class="row">
      ...
      <div class="row">
        <div class="col s12">
        <h5 class="red-text"> Medications Taken:</h5>
          <div class="input-field inline">
          <input  type="text" name="medi" class="validate">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col s12">
        <h5 class="red-text"> Comorbidities:</h5>
          <div class="input-field inline">
          <input type="text" name="comor" class="validate">
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col s12">
          <h5 class="red-text"> Doubts/clarifications:</h5>
            <div class="input-field inline">
          <input name="ques" type="text" data-length="500">
          </div>
        </div>
      </div>
    </div>
